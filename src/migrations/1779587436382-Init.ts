...
export class Init1779587436382 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."ubicaciones_tipo_enum" AS ENUM('aula', 'laboratorio', 'hospital')`);
        await queryRunner.query(`CREATE TYPE "public"."ubicaciones_estado_enum" AS ENUM('activa', 'inactiva')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."horarios_tipo_actividad_enum" AS ENUM('clase', 'laboratorio', 'rote')`);
        await queryRunner.query(`CREATE TYPE "public"."horarios_estado_enum" AS ENUM('activo', 'suspendido')`);
        ...
        await queryRunner.query(`CREATE TABLE "paralelos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "materia_id" uuid NOT NULL, "numero" character varying(5) NOT NULL, "docente_id" uuid NOT NULL, "capacidad" integer, "semestre_academico" character varying(10) NOT NULL, CONSTRAINT "PK_5700c8c67101f9c34d55b1f9593" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."docentes_estado_enum" AS ENUM('activo', 'inactivo')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."usuarios_rol_enum" AS ENUM('admin', 'docente', 'director')`);
        ...
        await queryRunner.query(`CREATE TABLE "sesiones" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "usuario_id" uuid NOT NULL, "token" text NOT NULL, "ip" character varying(100), "user_agent" text, "activa" boolean NOT NULL DEFAULT true, "fecha_creacion" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e4237ef09f1dc217c1660f23253" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."justificaciones_estado_enum" AS ENUM('pendiente', 'aprobada', 'rechazada')`);
        await queryRunner.query(`CREATE TABLE "justificaciones" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "marcado_id" uuid NOT NULL, "docente_id" uuid NOT NULL, "motivo" text NOT NULL, "archivo" character varying(500), "estado" "public"."justificaciones_estado_enum" NOT NULL DEFAULT 'pendiente', "observaciones" text, "fecha_revision" TIMESTAMP WITH TIME ZONE, "fecha_creacion" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_deb789868dab7efbd772accbce8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "marcados" ADD CONSTRAINT "FK_56ae7e4d8062f7e2992654a00c0" FOREIGN KEY ("docente_id") REFERENCES "docentes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "marcados" ADD CONSTRAINT "FK_05f01b5c704129f50d27b7a6613" FOREIGN KEY ("horario_id") REFERENCES "horarios"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "marcados" ADD CONSTRAINT "FK_5d767770cba545f8ff9973b749b" FOREIGN KEY ("ubicacion_id") REFERENCES "ubicaciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "horarios" ADD CONSTRAINT "FK_4d416ad51cff759276bb28d7f30" FOREIGN KEY ("paralelo_id") REFERENCES "paralelos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "horarios" ADD CONSTRAINT "FK_4187713a57a3ea4ee0cb68606ba" FOREIGN KEY ("ubicacion_id") REFERENCES "ubicaciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "paralelos" ADD CONSTRAINT "FK_84a17426b507b7610c44b3d37a0" FOREIGN KEY ("materia_id") REFERENCES "materias"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "paralelos" ADD CONSTRAINT "FK_6613170f57d45ef24aa314f2417" FOREIGN KEY ("docente_id") REFERENCES "docentes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "paralelos" DROP CONSTRAINT "FK_6613170f57d45ef24aa314f2417"`);
        await queryRunner.query(`ALTER TABLE "paralelos" DROP CONSTRAINT "FK_84a17426b507b7610c44b3d37a0"`);
        await queryRunner.query(`ALTER TABLE "horarios" DROP CONSTRAINT "FK_4187713a57a3ea4ee0cb68606ba"`);
        await queryRunner.query(`ALTER TABLE "horarios" DROP CONSTRAINT "FK_4d416ad51cff759276bb28d7f30"`);
        await queryRunner.query(`ALTER TABLE "marcados" DROP CONSTRAINT "FK_5d767770cba545f8ff9973b749b"`);
        await queryRunner.query(`ALTER TABLE "marcados" DROP CONSTRAINT "FK_05f01b5c704129f50d27b7a6613"`);
        await queryRunner.query(`ALTER TABLE "marcados" DROP CONSTRAINT "FK_56ae7e4d8062f7e2992654a00c0"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."horarios_tipo_actividad_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."marcados_estado_asistencia_enum"`);
